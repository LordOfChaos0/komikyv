...
| `554 / 550 / 5.7.1 reject` | Конверт отклонён | `SMTP_FROM` должен совпадать с `SMTP_USER` (Яндекс запрещает отправку «с чужого адреса»); пример: `SMTP_FROM="Коми кыв <user@yandex.ru>"` |
