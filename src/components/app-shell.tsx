...
const STUDENT_NAV: NavItem[] = [
  ...
  { view: "speed-typing", label: "Скоропечать", icon: Keyboard, roles: ["student", "teacher", "admin"] },
  { view: "memory-cards", label: "Карточки памяти", icon: Grid3x3, roles: ["student", "teacher", "admin"] },
...
const TEACHER_NAV: NavItem[] = [
  ...
  { view: "speed-typing", label: "Скоропечать", icon: Keyboard, roles: ["teacher", "admin"] },
  { view: "memory-cards", label: "Память", icon: Grid3x3, roles: ["teacher", "admin"] },
  { view: "pronunciation", label: "Произношение", icon: Mic },
  { view: "listening", label: "Аудирование", icon: Headphones },
...
const ADMIN_NAV: NavItem[] = [
  ...
  { view: "speed-typing", label: "Скоропечать", icon: Keyboard, roles: ["admin"] },
  { view: "memory-cards", label: "Память", icon: Grid3x3, roles: ["admin"] },
  { view: "pronunciation", label: "Произношение", icon: Mic },
  { view: "listening", label: "Аудирование", icon: Headphones },
